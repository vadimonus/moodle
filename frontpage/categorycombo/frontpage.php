...
/**
 * The frontpage area showing categories combo list.
 *
 * @package    frontpage_categorycombo
...
/**
 * The class for frontpage area showing categories combo list.
 *
 * @copyright  2016 Vadim Dvorovenko <Vadimon@mail.ru>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class frontpage_categorycombo extends frontpage_base {
    ...
    public function output($courserenderer) {
        ...
        echo html_writer::link('#skipcourses', get_string('skipa', 'access', core_text::strtolower(get_string('courses'))),
